...
import { Home, Users, CreditCard, X, User, LogIn, UserPlus, Settings, ArrowUp, ArrowDown, BookUp } from 'lucide-react';
            ...
            <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-lg transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} 
                ...
                <div className="flex items-center justify-between h-24 px-6">
                    <div className="flex items-center space-x-2">
                        <Image src={Logo} width={32} height={32} alt='CleanPoint Logo' />
                        <span className="text-xl font-bold text-[#00b17f]">CleanPoint</span>
                    </div>
                ...
                <nav className="mt-6 px-6 space-y-1">
                    ...
                    <Link href="/dashboard/reports"
                        className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${isActive('/dashboard/reports')
                            ? "bg-blue-100 dark:bg-blue-600/20 text-blue-700 dark:text-blue-400 border-r-4 border-blue-600"
                            : "text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"}`}>
