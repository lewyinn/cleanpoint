...
<section id="home" className="pt-24 md:pt-44 pb-12 md:pb-20 px-4 sm:px-6 lg:px-8 bg-white">
  <div className="container mx-auto">
    ...
    <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
      <button className="pl-4 pr-2 md:pl-6 py-3 bg-[#007E5B] text-white rounded-full hover:bg-white hover:border-[#007E5B] hover:text-[#007E5B] transition-colors font-medium flex items-center justify-center space-x-2">
        <span className="text-base md:text-xl">Laporkan Sekarang</span>
        <span className='bg-white text-black px-2 py-2 rounded-full'><MoveUpRight size={18} /></span>
      </button>
      <button className="text-base md:text-xl px-6 md:px-8 py-3 border-2 border-[#007E5B] text-[#007E5B] rounded-full hover:bg-emerald-50 transition-colors font-medium">
        How It Works
      </button>
    </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-[#007904] rounded-2xl p-6">
            <div className="flex flex-col gap-4">
              ...
              <button className="pl-3 pr-2 py-2 bg-white text-[#007904] rounded-full hover:bg-[#007904] hover:text-white hover:border-white border-2 transition-colors font-medium flex items-center justify-center space-x-2 group">
        ...
        <div className="flex flex-col gap-2">
          <div className="bg-[#007904] rounded-2xl p-6">
            <div className="flex flex-col gap-4">
              ...
              <button className="pl-2 pr-1 md:pl-4 py-2 bg-white text-[#007904] rounded-full hover:bg-[#007904] hover:text-white hover:border-white border-2 transition-colors font-medium flex items-center justify-center space-x-2 group">
                <span className="text-sm">Laporkan Sekarang</span>
                <span className='bg-[#007904] text-white group-hover:bg-white group-hover:text-[#007904] px-2 py-2 rounded-full'>
                  <MoveUpRight size={18} />
                </span>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-[#007E5B] px-6 py-10 md:px-12">
            ...
            <div className="relative z-10 max-w-4xl">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <button className="text-base md:text-lg inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-[#007E5B] shadow hover:bg-emerald-600 hover:text-white transition group cursor-pointer">
                  Laporkan Sekarang
                ...
                <button className="rounded-full border border-white/80 px-5 py-2.5 text-base md:text-lg text-white hover:bg-white hover:text-[#007E5B] transition cursor-pointer">
                  Cek Laporan Anda
                </button>
              </div>
            </div>
