...
// Terima props params untuk unwrap di Next.js 15
export default function DetailLaporanPage({ params: paramsPromise }) {
    // UNWRAP PARAMS (Solusi Error Next.js 15)
    ...
    if (loading) return null; // Bisa diganti skeleton dengan layout yang sama
    if (!report) return <div className="p-20 text-center">Laporan tidak ditemukan</div>;
        ...
        <main className="min-h-screen bg-white text-[#111827]">
            ...
            <section className="pt-24 md:pt-40 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto text-center">
                    <div className="flex items-start mb-8">
                        <Link href="/laporan" className="btn-primary flex items-center gap-2">
                            <ArrowLeft size={18} />
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-2xl p-6">
                            <h3 className="font-semibold text-lg mb-5">Informasi Laporan</h3>
                        ...
                        <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-2xl p-6">
                            <h3 className="font-semibold text-lg mb-4">Lokasi Kejadian</h3>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-2xl overflow-hidden">
                            <img
                                src={report.imageUrl || "https://images.unsplash.com/photo-1598632640487-8680aa1c7f48"}
                        ...
                        {/* Maps - Perbaikan URL Embed */}
                        <div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded-2xl overflow-hidden">
                            <iframe
                                src={`http://googleusercontent.com/maps.google.com/3{encodeURIComponent(report.location?.address || "Indonesia")}&t=&z=13&ie=UTF8&iwloc=&output=embed`}
            ...
            <section className="px-4 sm:px-6 lg:px-8 pb-20">
                <div className="max-w-7xl mx-auto">
                    <Link href="/laporan" className="inline-flex items-center gap-2 text-sm border border-[#E5E7EB] rounded-full px-6 py-3 hover:bg-[#F9FAFB] transition">
                        <ArrowLeft size={18} />
                        Kembali ke Daftar Laporan
                    </Link>
                </div>
